$(function () {
    ...
    $(".link-Schedule").hover(function () {
        $(".section-description").html("BTV Video release schedule")
    }, function () {
        $(".section-description").html(" Since 2005, Bayyinah Institute has been sharing the message and language of the Quran with the world")
    });
    $(".link-Careers").hover(function () {
        $(".section-description").html("Job openings in Bayyinah.")
    }, function () {
        $(".section-description").html(" Since 2005, Bayyinah Institute has been sharing the message and language of the Quran with the world")
    });
    ...
    }else if(page == "ccr.html"){
        $(".link-Careers>a").toggleClass('bold');
    }else if(page == "btv_schedule.html"){
        $(".link-Schedule>a").toggleClass('bold');
    }
